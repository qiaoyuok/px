        ...
        <el-form ref="goods" :model="goods" label-width="80px" inline="true" :rules="rules" class="col-md-9">
            <div class="col-md-6">
                <el-form-item label="商品类型" prop="goodsType">
                    <el-radio-group v-model="goods.goodsType">
                        <el-radio :label="1">会员账号类</el-radio>
                        <el-radio :label="2">普通商品</el-radio>
                    </el-radio-group>
                </el-form-item>
                <br>
                ...
                <el-form-item label="账号类型" v-if="goods.goodsType==1" prop="accountType">
                    <el-radio-group v-model="goods.accountType">
                        <el-radio v-for="(item,index) in accountTypes" :label="item">
                            {{item|accountFilter(baseConfig.accountType)}}
                        </el-radio>
                    </el-radio-group>
                </el-form-item>
                <br v-if="goods.goodsType==1">
                <el-form-item label="会员类型" v-if="goods.goodsType==1" prop="vipType">
                    <el-radio-group v-model="goods.vipType">
                        <el-radio v-for="(item,index) in vipTypes" :label="item">
                            {{item|accountFilter(baseConfig.vipType)}}
                        </el-radio>
                    </el-radio-group>
                </el-form-item>
                <br>
                <el-form-item label="支持分期" prop="fenqi">
                    <el-checkbox-group v-model="goods.fenqi">
                        <el-checkbox v-for="(item,index) in fenqis" :label="item" name="type">
                            {{item|accountFilter(baseConfig.fenqi)}}
                        </el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
                <br>
                ...
                <block v-for="(attribute, index) in goods.attributes">
                    <el-form-item
                        ...
                        <el-input v-if="goods.goodsType==2" v-model="attribute.attribute" style="max-width: 80px"></el-input>
                    </el-form-item>
                    <el-form-item
                            label="现价"
                            label-width="65px"
            ...
            <div class="col-md-6">
                <el-form-item label="商品详情">
                    <script style="min-width: 800px;" v-model="goods.content" id="goods-edit" type="text/plain">
                        {{goods.content}}
                    </script>
                    </el-form-item>
                    </div>
